...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_XENOPHOBIC = span_warning("Las especies menores contaminan nuestra tierra"),
	TRAIT_TOLERANT = span_info("Sueño con un futuro ideal, uno con paz entre todas las especies."),
	...
	TRAIT_NOBLE_BLOOD = span_blue("Soy de sangre noble."),
	...
	TRAIT_SLEEPIMMUNE = span_warning("No puedo dormir."),
	...
	TRAIT_NOFALLDAMAGE1 = span_info("Puedo manejar facilmente caidas menores."),
	TRAIT_NOFALLDAMAGE2 = span_info("Puedo soportar una caida desde cualquier altura."),
	TRAIT_ROT_EATER = span_necrosis("Puedo comer comida podrida."),
	TRAIT_ORGAN_EATER = span_bloody("Puedo comer organos y carne cruda."),
	TRAIT_BLOODDRINKER = span_bloody("Puedo beber la sangre de otros y digerirla."),
	...
	TRAIT_CYCLOPS_LEFT = span_warning("Me han sacado el ojo izquierdo..."),
	...
	TRAIT_MISSING_NOSE = span_warning("Lucho por respirar."),
	TRAIT_DISFIGURED = span_warning("Nadie puede reconocerme..."),
	TRAIT_BEAUTIFUL = span_love("¡Mi cara fue moldeada por los dioses!"),
	TRAIT_FAT = span_warning("Necesito perder algo de peso..."),
	...
	TRAIT_FISHFACE = span_necrosis("Otras especies me encuentran horrible."),
	TRAIT_SPELLBLOCK = span_warning("No puedo lanzar ningun hechizo."),
	...
	TRAIT_DIVINE_SERVANT = SPAN_GOD_GENERIC("Sirvo a lo divino."),
	...
	TRAIT_LEGENDARY_ALCHEMIST = span_info("Un experto en el arte de encontrar hierbas en la naturaleza."),
	...
	TRAIT_LIGHT_STEP = span_info("Nunca tropezare con una placa trampa."),
	TRAIT_NOFIRE = span_info("I am immune to most scorching flames."),
	TRAIT_ENGINEERING_GOGGLES = span_info("Puedo obtener mas informacion de los dispositivos mecanicos."),
	...
	TRAIT_MOONWATER_ELIXIR = span_info("Mi mente esta abierta, puedo entender las runas magicas."),
	TRAIT_SWIMMER = span_info("I can swim without being slowed and against the flow of rivers."),
	TRAIT_NODROWN = span_info("Puedo respirar bajo el agua, no tengo miedo de ahogarme."),
	TRAIT_TINY = "I am small, it's hard to look people in the eyes.",
	TRAIT_FOREIGNER = span_notice("No soy de por aqui."),
	...
	TRAIT_AMAZING_BACK = span_notice("¡Puedo cargar mucho mas en mi espalda!"),
	TRAIT_HOLLOWBONES = span_danger("Mis huesos son ligeros como el aire, es dificil llevar armadura."),
	...
	TRAIT_KITTEN_MOM = span_info("Los gatitos te aman, ven que eres padre."),
	...
	TRAIT_FLOWERFIELD_IMMUNITY = span_info("Soy inmune a los efectos de los campos de flores."),
	...
	TRAIT_NOENERGY = span_info("No necesito descansar; Nunca sentire fatiga."),
	...
	TRAIT_POISON_RESILIENCE	= span_info("Soy mas resistente a los venenos."),
	TRAIT_FORAGER = span_info("Puedo decir que jacksberries son venenosas."),
	TRAIT_SEED_FINDER = span_info("Encuentro semillas mas facilmente."),
	...
	TRAIT_ABOMINATION = span_info("Soy una abominacion, los demas me reconoceran por lo que soy."),

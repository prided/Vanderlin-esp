...
/datum/patron/godless/godless //lol lmao
	...
	sins = "Idolatría, adoración, fe ciega"
	boons = "None, you godless heathen."

	confess_lines = list(
		"NO GODS, NO MASTERS! THERE IS ONLY ME!",
		"UN HOMBRE ELIGE, UN ESCLAVO OBEDECE - ¡SERÉ LIBRE DE LOS DIOSES!",
...
/datum/patron/godless/defiant
	...
	sins = "Obediencia, Sumisión"
	boons = "None."

	confess_lines = list(
		"I WILL NEVER BOW TO ANYONE- NOT EVEN THE DIVINE!",
		"¡UN HOMBRE ELIGE, UN ESCLAVO OBEDECE! ¡SERÉ LIBRE DE LOS DIOSES!",
		"¡NADIE TIENE AUTORIDAD SOBRE MÍ, NI SIQUIERA LOS DIOSES!"
	)
...
/datum/patron/godless/dystheist
	...
	worshippers = "Escépticos, los desilusionados"
	sins = "Fe ciega"
	boons = "None."
...
/datum/patron/godless/galadros
	name = "Galadros"
	domain = "El Gran Wyrm en el corazón de Kruskros, Krusnakell"

...
/proc/spawn_rivers(target_z, nodes = 4, turf_type = /turf/open/water/swamp, whitelist_area = /area/outdoors/river, min_x = RANDOM_LOWER_X, min_y = RANDOM_LOWER_Y, max_x = RANDOM_UPPER_X, max_y = RANDOM_UPPER_Y, new_baseturfs)
...
/obj/effect/landmark/river_waypoint
	name = "punto de referencia del rio"
	var/connected = 0

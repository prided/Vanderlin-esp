...
/atom/movable/MouseDrop_T(mob/living/M, mob/user)
	. = ..()
...
/atom/movable/proc/buckle_mob(mob/living/M, force = FALSE, check_loc = TRUE, buckle_mob_flags= NONE)
	...
	// M.throw_alert(ALERT_BUCKLED, /atom/movable/screen/alert/restrained/buckled, new_master = add_src_icon ? src : null)
...
/atom/movable/proc/user_unbuckle_mob(mob/living/buckled_mob, mob/user)
	if(!(buckled_mob in buckled_mobs) || !buckled_mob.CanReach(user))
		return

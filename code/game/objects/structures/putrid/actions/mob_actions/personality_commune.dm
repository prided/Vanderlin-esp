...
/datum/action/personality_commune
	...
	var/fluff_text = span_boldnotice("Escuchas una voz que hace eco en la parte posterior de tu cabeza...")
...
/datum/action/personality_commune/Trigger(mob/clicker, trigger_flags)
	...
	personality_body.balloon_alert(personality_body, "escuchas una voz")

/datum/action/cooldown/spell/eoran_bloom
	...
	invocation = "Este en paz con Eora."
...
/datum/action/cooldown/spell/eoran_bloom/cast(atom/cast_on)
	...
	if(to_pacify.get_item_by_slot(ITEM_SLOT_HEAD))
		to_chat(owner, span_warning("La cabeza del objetivo esta cubierta. Las flores de Eora necesitan un espacio abierto para florecer."))
		return

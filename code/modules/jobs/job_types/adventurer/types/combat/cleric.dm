...
/datum/job/advclass/combat/cleric/on_roundstart(mob/living/carbon/human/spawned, client/player_client)
	...
	var/weaponchoice = spawned.select_equippable(player_client, selectableweapon, message = "Elige tu especializacion", title = "Warrior of the ten!")
	if(!weaponchoice)
		return

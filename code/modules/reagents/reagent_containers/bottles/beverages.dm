...
/obj/item/reagent_containers/glass/bottle/beer/stonebeardreserve
	desc = "Una botella con el sello de corcho de la Casa Stoutenson."
...
/obj/item/reagent_containers/glass/bottle/wine/sourwine
	desc = "Una botella con un sello de corcho de tinta negra."
...
/obj/item/reagent_containers/glass/bottle/redwine
	...
	auto_label_name = "joven valorian rojo"
...
/obj/item/reagent_containers/glass/bottle/whitewine
	...
	auto_label_name = "dulce valorian blanco"
...
/obj/item/reagent_containers/glass/bottle/elfred
	desc = "Una botella dorada con un sello de corcho plateado."
	list_reagents = list(/datum/reagent/consumable/ethanol/elfred = 75)
	auto_label_name = "valorian rojo"
...
/obj/item/reagent_containers/glass/bottle/elfblue
	desc = "Una botella dorada con un sello de corcho dorado."
	list_reagents = list(/datum/reagent/consumable/ethanol/elfblue = 75)
	auto_label_name = "azul valmora"
...
/obj/item/reagent_containers/glass/bottle/nred
	desc = "Una botella con el sello de corcho del Clan Aurum."
	list_reagents = list(/datum/reagent/consumable/ethanol/nred = 48)
	auto_label_name = "oro fundido"
...
/obj/item/reagent_containers/glass/bottle/avarmead
	...
	auto_label_desc = "Un vino de miel dorado elaborado en las estepas. Logra mantener un sabor adecuado mientras se mantiene fuerte."

/obj/item/reagent_containers/glass/bottle/avarrice
	desc = "A bottle with a simple cork-seal."
	list_reagents = list(/datum/reagent/consumable/ethanol/avarrice = 48)
	auto_label_name = "arroz de estepa"
...
/obj/item/reagent_containers/glass/bottle/kgunsake
	desc = "Una botella con un sello de corcho Golden Swan."
...
/obj/item/reagent_containers/glass/bottle/kgunplum
	...
	desc = "Una botella con un sello de corcho Golden Swan."
	auto_label_name = "aguardiente de frutas"
...
/obj/item/reagent_containers/glass/bottle/black/huangjiu
	desc = "Una botella con un sello rojo."
...
/obj/item/reagent_containers/glass/bottle/black/nocshine
	desc = "Una botella con una marca de luna creciente azul."
	list_reagents = list(/datum/reagent/consumable/ethanol/nocshine = 48)
	auto_label_name = "noc brillo"

...
/datum/essence_combo/spell/single/frost
	name = "Frost Mastery"
...
/datum/essence_combo/spell/single/light
	name = "Light Mastery"
	required_essences = list(/datum/thaumaturgical_essence/light)
...
/datum/essence_combo/spell/single/order
	name = "Order Mastery"
...
/datum/essence_combo/spell/single/poison
	name = "Poison Mastery"
	required_essences = list(/datum/thaumaturgical_essence/poison)

	granted_spells = list(/datum/action/cooldown/spell/essence/neutralize, /datum/action/cooldown/spell/essence/detect_poison)

/datum/essence_combo/spell/single/crystal
	name = "Crystal Mastery"
	required_essences = list(/datum/thaumaturgical_essence/crystal)

	granted_spells = list(/datum/action/cooldown/spell/essence/gem_detect)

/datum/essence_combo/spell/single/magic
	name = "Magic Mastery"
	required_essences = list(/datum/thaumaturgical_essence/magic)

/obj/item/organ/heart
	...
	high_threshold_passed = span_warning("Algo dentro de mi pecho duele y el dolor no disminuye. Estoy respirando mucho mas rapido que antes.")
	now_fixed = span_info("Mi corazon comienza a latir de nuevo.")
